      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mt-12">
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-brand-dark tracking-tight">Iniciar una reparación</h2>
            <p className="text-brand-muted mt-2 text-sm max-w-sm mx-auto">
              Elige tu tienda más cercana y pregúntanos por WhatsApp — te respondemos enseguida.
            </p>
          </div>
