...
const CITY_DATA: Record<CitySlug, {
  ...
  porrino: {
    ...
    address: 'Rúa Ramón González, 54, 36400 O Porriño, Pontevedra',
    ...
    services: [
      { name: 'Cambio de pantalla iPhone', price: 'Desde €49', time: '30-60 min' },
      { name: 'Cambio de pantalla Samsung', price: 'Desde €49', time: '30-60 min' },
      { name: 'Cambio de batería', price: 'Desde €25', time: '20-30 min' },
      { name: 'Reparación conector carga', price: 'Desde €25', time: '45-60 min' },
      { name: 'Fundas y protectores', price: 'Desde €6.90', time: 'Inmediato' },
      { name: 'Cargadores y cables', price: 'Desde €3.50', time: 'Inmediato' },
    ],
    faq: [
  ...
  baiona: {
    ...
    address: 'Rúa Carabela a Pinta, 14, 36300 Baiona, Pontevedra',
    ...
    faq: [
      { q: '¿Dónde estáis en Baiona?', a: 'Estamos en Rúa Carabela a Pinta, 14, en el centro de Baiona, muy cerca del Parador y del paseo marítimo.' },
  ...
  lalin: {
    ...
    address: 'Rúa Wenceslao Calvo Garra, 10, 36500 Lalín, Pontevedra',
